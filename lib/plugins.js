...
function fcc(e, t, n, i) {
  ...
  if((n && n.type === "low") || (n && n.loudness === 3))
    ...
    u.append($("<div />", { class: "bubble" }).append(a));
  ...
  if(n && n.loudness) m.addClass("loudness-" + n.loudness);
  if((n && n.type === "low") || (n && n.loudness === 3)) m.addClass("low");
...
function monit_503(){
  let connectionIndicator = $('#connection-indicator')[0];
  if(!connectionIndicator){
    console.warn("[drrr-botext] Connection indicator was not found; skipping the 503 observer.");
    return;
  }
  ...
  observer.observe(connectionIndicator, {
